<template>
    <div>
        <div class="service">
            <p class="switch">
                <span class="switch1" @click="isShowService = 1">订单服务</span>
                <span class="switch2" @click="isShowService = 2">产品咨询</span>
            </p>
            <i class="iconfont icon-dianhua"></i>
        </div>
        <!-- <serviceTop></serviceTop>    -->
        <serviceOrder v-if="isShowService == 1"></serviceOrder>
        <div v-if="isShowService == 2">
            <serviceNav></serviceNav>
            <serviceSuit></serviceSuit>
        </div>
    </div>
</template>
